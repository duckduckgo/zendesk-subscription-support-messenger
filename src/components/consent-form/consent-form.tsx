    ...
    <div className={styles.card}>
      ...
      <div className={styles.content}>
        <div className={styles.section}>
          <p>
            DuckDuckGo Subscription support uses an AI Agent powered by Zendesk
            (the &quot;AI Agent&quot;) to perform customer support functions,
            including interacting with users via AI chat bot. The AI Agent
            allows DuckDuckGo to respond to users quickly and efficiently by
            accessing our help pages and assisting users with questions related
            to the Subscription Service. Zendesk is a third party and the
            information you submit is transmitted to Zendesk&apos;s AI. Please
            keep this in mind when determining what information you provide to
            the AI Agent.
          </p>
          ...
          <p>
            The AI Agent collects information submitted through the chat bot and
            a third party Zendesk script [insert any other methods] and
            processes support transcripts so that it can automate conversations,
            provide analytics, and improve the service. DuckDuckGo and Zendesk
            collect other automated data related to your support session, such
            as page impressions, consent preference, chat session IDs, errors,
            and button clicks. Zendesk also sets cookies to support
            functionality such as cross-tab messaging, to which you may opt out.
            Certain Zendesk cookies are required for the chat bot to function
          ...
          <p>
            ...
            support requests and conversations, but we take additional steps to
            protect your privacy during the support process. For example, the AI
            Agent is isolated in a separate subdomain to separate it from other
            sensitive data. For incoming data, Zendesk anonymizes certain types
            of personal information to prevent them from being processed, such
            as bank account numbers, credit cards, and social security numbers,
            though this does not guarantee complete &quot;anonymization&quot; or
            removal of all personal information submitted to the chat bot. We
            also take steps to prevent the script from storing potentially
            sensitive data in the DuckDuckGo browser beyond the support chat
            session. See Zendesk&apos;s privacy policy for more information.
          </p>
          ...
          <p>
            ...
            tokenizes the remaining data before using it to train its AI models.
            Further, according to Zendesk, no training datasets are stored
            within any Zendesk model. See
            https://support.zendesk.com/hc/en-us/articles/5729714731290-Zendesk-AI-Data-Use-Information
            for more information. While the parties have taken various steps to
            prevent your personal information from being used in training,
            DuckDuckGo cannot completely guarantee that no personal information
            will be used for training Zendesk AI models.
          </p>
          ...
          <p>
            ...
            DuckDuckGo privacy policy) and this policy, the terms of this policy
            will prevail.
          </p>

          <p>
            By selecting &quot;{CONSENT_BUTTON_TEXT}&quot;, you acknowledge and
            consent to the following:
          </p>

          <p>
            By opting into the AI Agent, I understand that a third party
            (Zendesk) script will be loaded and the AI chat bot will be enabled
            for my [account/device].
          </p>
          ...
          <p>
            By clicking &quot;{CONSENT_BUTTON_TEXT}&quot;, you confirm that you
            have read, understand, and consent to DuckDuckGo&apos;s collection,
