      ...
      <div className={styles.footerContent}>
        ...
        <div className={styles.footerSection}>
          ...
          <p className={styles.footerText}>
            ...
            information from hackers, scammers, and privacy-invasive companies is
            to stop it from being collected at all. That&apos;s why millions of
            people{' '}
            <a
              target="_blank"
              rel="noopener"
            ...
            companies from collecting your data. Oh, and our browser is free — we
            make money from{' '}
            <a
              target="_blank"
              rel="noopener"
            ...
            <a
              ...
              rel="noopener"
              className={styles.footerTextLink}
              href="https://duckduckgo.com/mac?origin=funnel_marketing_searchresults"
            >
              Mac
            </a>
            ,{' '}
            <a
              ...
              rel="noopener"
              className={styles.footerTextLink}
              href="https://duckduckgo.com/windows?origin=funnel_marketing_searchresults"
            >
              Windows
            </a>
            ,{' '}
            ...
            <a
              ...
              rel="noopener"
              className={styles.footerTextLink}
              href="https://play.google.com/store/apps/details?id=com.duckduckgo.mobile.android&referrer=origin%3Dfunnel_marketing_searchresults"
            >
              Android
            </a>
            .
